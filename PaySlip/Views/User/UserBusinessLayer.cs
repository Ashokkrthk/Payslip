    ...
    public class UserBusinessLayer
    {
        ...
        public void AddUser(User userObj)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Password", "Test@1234");
        ...
        public User Login(string userName, string password)
        {
            ...
            if(isUserExist)
            {
                ...
                {                    
                    ...
                    objDetails.Bank_Name = Convert.ToString(dr["Bank_Name"]);
                    objDetails.Account_Number = Convert.ToString(dr["Account_Number"]);
                    objDetails.UAN_Number = Convert.ToString(dr["UAN_Number"]);
                }
            }
            return objDetails;
        }
